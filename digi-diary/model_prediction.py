...
train_data = pd.read_csv("D:/Kunal Programming/PYTHON/NLP-Python/PRO-C118-Student-Boilerplate-Code/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("D:/Kunal Programming/PYTHON/NLP-Python/PRO-C118-Student-Boilerplate-Code/static/assets/model_file/Tweets_Text_Emotion.h5")
...
#Display entry
def show_entry():
    day_entry_list = pd.read_csv("D:/Kunal Programming/PYTHON/NLP-Python/PRO-C118-Student-Boilerplate-Code/static/assets/data_files/data_entry.csv")
